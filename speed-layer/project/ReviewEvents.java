...
public class ReviewEvents {
     ...
     * */
    private static Heap heap = new Heap(CompareStrategy.TOTAL);
     ...
     * */
    private static final String OUTPUT_DIR_USER = "/home/giap/test/reviews-events/";
    private static final String OUTPUT_DIR_MOVIE = "/home/giap/test/reviews-events/";

    private static final Properties PROPERTIES = new Properties();
    private static final String BOOTSTRAP_SERVER = "localhost:9092";
    private static final String TOPIC = "reviews-events";
    private static final String GROUP_ID = "reviews-events-group";
            ...
            while (true) {
                ...
                for (ConsumerRecord<String, String> record : records) {
                    ...
                    if (System.nanoTime() - checkpoint >= TIME_INTERVAL) {
                        FileWriter fileWriter = new FileWriter(OUTPUT_DIR_USER + PROCESS_ID + ".txt");
                        ...
                        heap = new Heap(CompareStrategy.TOTAL);
                        PROCESS_ID++;
